...
import { cancelJobApplication, externalJobDetailPath } from "../api/jobs";
...
export default function MyPage() {
  ...
  return <main className="mypage-main">
    <section className="mypage-profile-card"><div className="mypage-avatar">{avatarUrl ? <img src={avatarUrl} alt={`${displayName} 프로필`} /> : <BrandCharacter pose="work" />}</div><div className="mypage-profile-copy"><span>MY PAGE</span><h1>{displayName}님의 기록</h1><p>{email || "이메일 정보 없음"}</p></div><div className="mypage-profile-actions"><button onClick={logout}>로그아웃</button></div></section>
