...
export default function GatheringWritePage() {
  ...
  useEffect(() => { getRegions().then((result) => setRegions(asList(result, "regions"))).catch((requestError) => { setError(true); setMessage(requestError.message); }); }, []);
